...
echo == Copying files to %USERPROFILE%\janban...
robocopy /mir . %USERPROFILE%\janban > nul 
echo == Complete.
...
if not %offver%==0 (
      ...
      reg add HKCU\Software\Microsoft\Office\%offver%.0\Outlook\Today /v UserDefinedUrl /t REG_SZ /d %USERPROFILE%\janban\kanban.html /f  > nul 2> nul
